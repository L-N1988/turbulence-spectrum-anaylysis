...
pre_C = plot(f_C(f_C <= 65), f_C(f_C <= 65) .* pxx_C(f_C <= 65), 'Color', blue);
hold on
pre_L = plot(f_L, f_L.* pxx_L, 'Color', orange);
pre_CL = plot(concate_f(concate_f <= 65), concate_f(concate_f <= 65) .* concate_pxx(concate_f <= 65), 'Color', green);
