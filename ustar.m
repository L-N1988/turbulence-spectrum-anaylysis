...
% velocity at each horizontal plane
u_h = [
    0.0152	0.099980439	0.210982265	0.31879817
...
scatter(u1_lam / u_t(1), z1/H, 80, "o");
scatter(u2_lam / u_t(2), z2/H, 80, "^");
scatter(u3_lam / u_t(3), z3/H, 80, "square");
...
scatter(u1_pri / u_t(1), z1/H, 80, "o");
scatter(u2_pri / u_t(2), z2/H, 80, "^");
scatter(u3_pri / u_t(3), z3/H, 80, "square");
...
p1 = scatter(u1 / u_t(1), z1 / H, 80, "o");
p2 = scatter(u2 / u_t(2), z2 / H, 80, "^");
p3 = scatter(u3 / u_t(3), z3 / H, 80, "square");
scatter(u_h(:, 2) / u_t(1), u_h(:, 1) / H, 100, 'blue', 'filled', "o");
scatter(u_h(:, 3) / u_t(2), u_h(:, 1) / H, 100, 'red', 'filled', "^");
scatter(u_h(:, 4) / u_t(3), u_h(:, 1) / H, 100, 'yellow', 'filled', "square");
xlim([0, 1]);
