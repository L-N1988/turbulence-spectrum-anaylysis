...
Y_C = data_C.local_Ys; Y_L = data_L.local_Ys(2:end);
U_C = data_C.local_Us; U_L = data_L.local_Us(2:end);
urms_C = data_C.u_rms; urms_L = data_L.u_rms(2:end);
pxxs_C = data_C.pxxs; pxxs_L = data_L.pxxs(2:end);
fs_C = data_C.fs; fs_L = data_L.fs(2:end);
