...
for ipxx = 1:length(data.concate_pxxs)
    ...
    flim = 2; noise_f = 0.075:0.075:flim; % 4.5:0转速比
    ...
    epsname = sprintf("./concate_figures/PSD-concate-%d.eps", ipxx);
    figname = sprintf("./concate_figures/PSD-concate-%d.fig", ipxx);
    ...
    epsname = sprintf("./concate_figures/pre-PSD-concate-%d.eps", ipxx);
    figname = sprintf("./concate_figures/pre-PSD-concate-%d.fig", ipxx);
